...
public class DirectoryCopier implements Runnable
{
 /*
  	 ...
  	 serverAddress
  	 	is an InetSocketServer that holds the servers address

  	  serialVersionUID
  	   allows object to be serializable

  	  sourceDirectory
  	   holds the original directory where everything will be copied from

  	  fileFilter
  	   holds a fileFilter object

  	  targetDirectory
  	  	holds the target directory where everything will be copied to
  	 ...
  	 Methods:
  	  ...
  	  public void run()
  	   Class faciliates the connection between the server and client allowing RequestMessages and ResponseMessages to be tossed
  	   back and forth to allow the copying to happen.
